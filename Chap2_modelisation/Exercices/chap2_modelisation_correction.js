...
const programmation = db.categories.findOne({
    name: "Programmation"
});
const SQL = db.categories.findOne({
    name: "SQL"
});
const NoSQL = db.categories.findOne({
    name: "NoSQL"
});
...
const newBooks = [{
    ...
    }, // Programmation NoSQL SQL
    {
        title: "Pandas & SQL & NoSQL"
    }, // SQL, NoSQL et Programmation
    {
...
db.books.insertOne({
    title: "Python & SQL",
    category_id: [SQL._id, programmation._id]
});
db.books.insertOne({
    title: "JS, SQL ou NoSQL",
    category_id: [SQL._id, programmation._id, NoSQL._id]
});
db.books.insertOne({
    title: "Pandas & SQL & NoSQL",
    category_id: [SQL._id, programmation._id, NoSQL._id]
...
const pushAncesstors = (_id, doc) => {
    if (doc.parent) {
        ...
        pushAncesstors(_id, db.categoriestree.findOne({
            _id: doc.parent
        }));
    }
}
